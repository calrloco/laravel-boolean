<div class="row">
    <div class="container container-lg container-md container-sm container-xl nav-bool">
        <div class="col-lg-2 col-5">
            <a href="">
                <img class="nav-bool__logo" src="https://www.boolean.careers/images/misc/logo.png" alt="logo">
            </a>
        </div>
